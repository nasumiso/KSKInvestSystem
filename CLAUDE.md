...
- **株価履歴**: `data/stock_data/yahoo/price/`, `data/stock_data/kabutan/price/`
- **市場指数**: `data/sisu_data/`
...
Yahoo Finance JapanとKabutanは頻繁にHTMLを変更する。データ取得失敗時:
...
- 主な依存: `requests`, `scipy`, Google API ライブラリ群, `oauth2client`
